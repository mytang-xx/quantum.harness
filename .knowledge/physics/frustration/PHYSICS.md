...
|---|---|
| Geometric (triangular, kagome, pyrochlore) | DMRG cylinder + ED; QMC blocked. VMC/NQS via NetKet for variational comparison (`.knowledge/methods/variational-monte-carlo-neural-quantum-states.md`). |
