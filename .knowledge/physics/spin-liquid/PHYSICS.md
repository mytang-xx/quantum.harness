...
How to compute each: see the relevant model card and method card (`.knowledge/methods/dmrg.md` etc.).
...
3. A pointer to the relevant literature range with citations from `.knowledge/benchmark-numbers.md`.
