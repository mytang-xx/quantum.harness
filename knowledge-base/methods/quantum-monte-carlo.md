...
`knowledge-base/benchmark-numbers.md`. Treat that as a benchmark comparison,
...
- **Benchmark comparison**: for square-lattice Heisenberg quantities, compare
  to the tagged values in `knowledge-base/benchmark-numbers.md`.

## Citations

- `knowledge-base/literature/qmc/1101.3281_computational-studies-of-quantum-spin-systems.md`
  - Sandvik, *Computational Studies of Quantum Spin Systems* (2010).
- `knowledge-base/literature/qmc/10-1017-9781316417041.md`
