...
- **Cross-method validation** (when feasible) — re-run on a small projected cluster with an independent method; use ED only after `knowledge-base/methods/ed/METHOD.md` is rebuilt. See AGENTS.md "Verification practice".
