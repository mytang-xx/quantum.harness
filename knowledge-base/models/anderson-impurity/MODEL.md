...
- **Cross-method validation** (when feasible) — cross-check star vs chain bath geometry; use ED only after `knowledge-base/methods/ed/METHOD.md` is rebuilt. See AGENTS.md "Verification practice".
