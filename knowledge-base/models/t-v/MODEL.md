...
| Regime | Method | Card |
|---|---|---|
| Small chain or 2D cluster (N ≲ 24) | ED pending refreshed references | `knowledge-base/methods/ed/METHOD.md` |
| 1D chain (any N), ladder | DMRG | `knowledge-base/methods/mps-based-algorithm.md` |
...
- **Cross-method validation** (when feasible) — re-run a small fixed-`N_f` cluster with an independent method, and check sign-problem-free QMC agreement when applicable. Use ED only after `knowledge-base/methods/ed/METHOD.md` is rebuilt. See AGENTS.md "Verification practice".
