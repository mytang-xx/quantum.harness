...
For each item, the relevant model card drives the wavefunction calculation; this skill specifies *what to compute* and *what to look for*. Definitions live in `knowledge-base/magic-conventions.md`.
